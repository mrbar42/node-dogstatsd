...
describe('StatsD', function() {
  ...
  describe('timing', function() {
    ...
    it('should include the tags if provided as array', function(done) {
      serverShouldReceive('latency:200|ms|#app:web,feature:on', done);
      client.timing('latency', 200, ['app:web', 'feature:on']);
    });
    it('should include the tags if provided as a set', function(done) {
      serverShouldReceive('latency:200|ms|#app:web,feature:on', done);
      client.timing('latency', 200, {app:'web', feature:'on'});
    });
  ...
  describe('event', function() {
    it('should send the event value', function(done) {
      serverShouldReceive('_e{11,10}:event_title|event_body', done);
